...
# No he encontrado ninguna forma de instalar el paquete mxnet, no se encuentra disponible
# para R 4.2.0, el siguiente código corresponde al script del profesor del curso
