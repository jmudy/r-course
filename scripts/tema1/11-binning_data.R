...
# Con breaks = un numero, R decide los rangos de los cortes
...
# Esta libreria ya no esta disponible instalar descargando
...
dummy(students$State, sep = '_') # Para crear variables dummy de una sola variable categorica
